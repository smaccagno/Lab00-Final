...
export default class Esperienze extends LightningElement {
  /*────────────────── STATE */
  @api recordId;
  @track relatedData = [];
  @track yearOptions = [];
  ...
  get disableMonthFilter() {
    return this.selectedType === "Abbonamento" || this.uiDisabled;
  }
  ...
  handleTypeChange = (e) => {
    ...
    if (this.selectedType === "Abbonamento") {
      this.selectedYear = "";
      this.selectedMonth = ""; // ⬅️ resetta anche il mese
    }
  ...
  get columns() {
    ...
    const base1 = [
      ...
      { label: "Tipologia", fieldName: "Type__c" },
      {
        label: "Spettacolo",
        fieldName: "showLink",
        type: "url",
